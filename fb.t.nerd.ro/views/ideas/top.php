...
<div>
    <table id="top_ideas">
            ...
            <?php
                ...
                foreach($ideas as $idea) {
                    if($odd % 2 == 0)
                        ...
                        echo "<tr>";
                    echo '<td><fb:name uid="'. $idea->aid .'" useyou="false" /></td>';
            ...
            <tr>
                ...
                ?>
                <a href="<?php echo SITE_URL; ?>ideas/top/<?php echo $page - 1; ?>">&larr; Go back</a> | Page <?php echo $page; ?></a>
                <?php
                    elseif($hasposts == 0) : //during pagination
                ?>
                <a href="<?php echo SITE_URL; ?>ideas/top/<?php echo $page - 1; ?>">&larr; Go back</a> | Page <?php echo $page; ?> | <a href="<?php echo SITE_URL; ?>ideas/top/<?php echo $page + 1; ?>">Next page &rarr</a>
                   <?php
                    elseif($hasposts > 0) : //on start
                ?>
                Page <?php echo $page; ?> | <a href="<?php echo SITE_URL; ?>ideas/top/<?php echo $page + 1; ?>">Next page &rarr</a>
                </th>
                <?php endif; ?>
                <th>&nbsp;</th>
                <th>&nbsp;</th>
