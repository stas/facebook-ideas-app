...
<?php if($invited) {
    echo "<div id=\"thankbox\" style=\"width:400px\">";
        echo $invited;
    echo "</div>";
} else {
?>
<fb:fbml >
    <fb:request-form action="<?php echo "http://apps.facebook.com/".$app_url."/".$invite_href; ?>" method="POST" invite="true"
        ...
        <fb:multi-friend-selector showborder="false" actiontext="Invite your friends to use <?php echo htmlentities($app_name,ENT_COMPAT,'UTF-8'); ?>." cols="10">
    </fb:request-form>
</fb:fbml>
<? }